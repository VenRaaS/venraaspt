...
var venraastool = {
	...
	recomd: function(paramJson, cbf) {
		...
		if (paramJson.hasOwnProperty('goods_keywords')) {
			paramJson.rec_type = 'AlsoView';
			paramJson.rec_logic = {"logic_list":[{"logic_name":"ClickStream","alg_list":[{"alg_name":"I2I_Model","model_type":"cooc_98","weight":1,"is_random_by_vig":false},{"alg_name":"I2I_Model","model_type":"content_i2i","weight":1,"is_random_by_vig":false}],"num_of_ref_cs":1,"random_cs_order":false,"filter_out_last_7_day_bought_items":true,"cs_must_in_current_categ_code":true,"use_all_alg_rec_gids":true,"weight_of_alg_rec_gids_size":5,"insert_cs_item_to_rec_items_first":false,"sort_by_socre":true,"add_key_terms_score":true},{"logic_name":"WhiteCategory","filter_out_last_7_day_bought_items":true,"weight_of_alg_rec_gids_size":1.5}]};
